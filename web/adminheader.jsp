...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #3500A6;">
    <a class="navbar-brand" href="#" style="margin-left: 20px"><div style='color:white'>OWO HOTEL</div></a>
    ...
    <div class="navbar-collapse collapse" id="collapseNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <form action="PaymentController" method="get">
                    <input type="hidden" name="function" value="viewpayment">
                    <input type="hidden" name="email" value="<% out.print(email);   %>">
                    <input type="submit" value="Payment History" class="btn waves-effect waves-light col s12" tabindex="5" style="border: 0; background: 0; color: white"> 
                </form>
            </li>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
                <a class="nav-item nav-link" href="logout.jsp"><div style='color:white; text-align:right; margin-right: 20px'>Logout</div></a>
            </li>
        </ul>
    </div>
